...
def load_default_config(config_name, verbose):
    ...
    #   This part -> ``'data_files/conf/fred/fred-client.conf'''
    ...
    error, names, not_found = load_config(config, 'data_files/conf/fred/fred-client.conf', verbose)
    if not_found:
...
def load_config(config, filename, verbose):
    ...
    if os.path.isfile(filename):
        ...
        try:
            ...
            # names = config.read([modul_conf, glob_conf, 'data_files/conf/fred/fred-client.conf'])
